      ...
      <div class="max-w-4xl mx-auto px-4">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex space-x-2">
            <button
              class="flex items-center gap-1 cursor-pointer bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
              @click="editRecipe"
            >
    ...
    <div class="max-w-4xl mx-auto p-6">
      ...
      <div v-else-if="recipesStore.currentRecipe" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div class="flex items-center text-gray-600">
                ...
                <span class="font-medium"
                  >{{ recipesStore.currentRecipe.duration_minutes }} Minuten</span
                >
              </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
          <h1 class="text-xl font-semibold mb-4">Zutaten für {{ currentPortions }} Portionen</h1>

          <div class="flex items-center space-x-3 mb-6">
            <button
              @click="currentPortions > 1 && currentPortions--"
              class="w-10 h-10 rounded-full bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center"
            ...
            <input
              type="number"
              v-model.number="currentPortions"
              min="1"
              class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none w-20 text-center border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
            />

            <button
              @click="currentPortions++"
              class="w-10 h-10 rounded-full bg-gray-200 hover:bg-gray-300 flex justify-center items-center"
            >
              +
            </button>
          </div>
        ...
        >
          <h2 class="text-xl font-semibold mb-4">Zubereitung</h2>
          <div class="mb-3" v-for="step in sortedSteps" :key="step.id">
            <div class="p-3 bg-gray-50 rounded-lg border space-x-3">
              <h3 class="font-semibold">Schritt {{ step.step_number }}:</h3>
